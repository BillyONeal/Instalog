...
class Library : boost::noncopyable
{
    ...
    ///
    /// @param [in,out] reporter Error reporting strategy to use. If the error reporting strategy does
    ///                          not throw an exception, then the library will be placed in an invalid
    ///                          state.
...
class RuntimeDynamicLinker : public Library
{
    ...
    /// @param [in,out] reporter The error reporting strategy to use. If the function fails and the
    ///                          reporter does not throw an exception, returns nullptr.

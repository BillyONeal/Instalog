...
namespace Instalog { namespace SystemFacades {
	...
	public:
		...
		static std::unique_ptr<RegistryKey> Open(std::wstring const& key, REGSAM samDesired = KEY_ALL_ACCESS);
		static std::unique_ptr<RegistryKey> Create(

...
Each input line should simply be the \var{id} for each extension that should be
removed.  
\item[Operation] \hfill \\
First, the files related to the \var{id} should be quarantine according to the

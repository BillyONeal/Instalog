...
\begin{description}
\item[Rationale] The default search URL is used to populate the search pane when
the user expands it. This is a machine wide setting. It may be overridden by
...
\begin{description}
\item[Rationale] \hfill \\
The default search URL is used to populate the search pane when
the user expands it. This user-specific setting overrides the machine wide

...
\begin{itemize}
  \item \verb|C:\WINDOWS\System32\csrss.exe|
  \item \verb|C:\WINDOWS\System32\winlogon.exe|
  \item \verb|C:\WINDOWS\System32\services.exe|
  \item \verb|C:\WINDOWS\System32\lsass.exe|
  \item \verb|C:\WINDOWS\System32\smss.exe|
\end{itemize}
...
to a specific web search site if they type an invalid URL. This is a machine wide
setting.
...
\begin{description}
\item[Rationale] \hfill \\ This is the web page shown by Internet Explorer when
the user selects ``Search'' on the toolbar.
\input{snippets/ie64bit.tex}
\item[Data Sources] \hfill
\vspace{-\baselineskip}
\begin{verbatim}
...
\begin{description}
\item[Rationale]  \hfill \\ This value contains information about the search bar
used in Internet Explorer versions 7 and 8.
\input{snippets/ie64bit.tex}
\item[Data Sources] \hfill
\vspace{-\baselineskip}
\begin{verbatim}
...
\begin{description}
\item[Rationale]  \hfill \\ This setting corresponds to Internet Explorer's home
page. If it exists, it overrides the machine-wide setting.
\input{snippets/ie64bit.tex}
\item[Data Sources] \hfill
\vspace{-\baselineskip}
\begin{verbatim}
...
\begin{description}
\item[Rationale]  \hfill \\ This is the web page shown by Internet Explorer when
the user selects ``Search'' on the toolbar. This user-specific setting overrides the
machine-wide setting if it exists.
\input{snippets/ie64bit.tex}
\item[Data Sources] \hfill
\vspace{-\baselineskip}
...
(\url{http://msdn.microsoft.com/en-us/library/windows/desktop/aa378951(v=vs.85).aspx}),

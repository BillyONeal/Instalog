...
\begin{description}
\item[Rationale]  \hfill \\ This setting corresponds to Internet Explorer's home
page. If this value is set, it overrides the machine-wide setting.
\input{snippets/ie64bit.tex}
\item[Data Sources] \hfill
\vspace{-\baselineskip}
\begin{verbatim}
...
\vspace{-\baselineskip}
\begin{verbatim}
[${CurrentUser}\Software\Microsoft\Internet Connection Wizard]
"ShellNext"="${url}"
\end{verbatim}
\item[Log Format] \hfill \\
...
\begin{verbatim}
; 32 Bit Registry View
[${CurrentUser}\Software\Microsoft\Internet Explorer\Search]
"SearchAssistant"="${url}"
; 64 Bit Registry View
[${CurrentUser}\Software\Microsoft\Internet Explorer\Search]
"SearchAssistant"="${url64}"
